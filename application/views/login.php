...
<html lang="en">
<head>
  <title>SISTEM INVENTORI & PEMESANAN UBSI Mart</title>
  <meta charset="UTF-8">
...
<!-- <img src="<?php echo base_url()."assets/images/icons/favicon.ico"; ?>"  > -->
...
<body>
  ...
  <div class="limiter">
    <div class="container-login100" style="background-image: url('assets/images/superindo.jpg');">
      <div class="wrap-login100">
        ...
        <form class="login100-form validate-form" role="form" action="app/login" method="post">
            ...
            <div class="login-logo">
              <center>
        <img src="<?php echo base_url()."assets/images/ubsi.jpg"; ?>" style="width: 30%; height: auto;">
      </div></center>
          ...
          <div class="wrap-input100 validate-input" data-validate = "Enter username">
            ...
            <span class="focus-input100" ><img src="<?php echo base_url()."assets/images/login.png"; ?>" style="width: 4%; "></span>
          </div>

          <div class="wrap-input100 validate-input" data-validate="Enter password">
            <input class="input100" type="password"  name="password" id="password" placeholder="Password">
            <span class="focus-input100" ><img src="<?php echo base_url()."assets/images/password.png"; ?>" style="width: 4%; height: auto;"></span>
          </div>
            ...
            <label class="label-checkbox100" for="ckb">
              Remember me
                                ...
                                <div class="text-center"> 
                                    <a class="small" href="<?= base_url('users/create.html'); ?>">Daftar Member?</a> 
                                </div> 
            </label>
